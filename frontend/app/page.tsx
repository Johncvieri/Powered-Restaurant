...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Your order processed immediately",
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-red-600 font-display">Choolights</h1>
                <p className="text-gray-600 text-sm font-body">Authentic Indonesian Cuisine</p>
              </div>
            </div>
      ...
      <section className="relative bg-gradient-to-r from-red-700 to-red-800 text-white py-24">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-bold mb-6 font-display animate-fade-in">
            Experience Authentic<br />Indonesian Cuisine
          </h2>
          <p className="text-xl mb-8 opacity-90 font-body max-w-2xl mx-auto">
            Traditional flavors meet modern convenience. Taste the real Indonesia.
          </p>
          <button className="bg-white text-red-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition duration-300 transform hover:scale-105 font-display">
            View Full Menu
          </button>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 font-display">Why Choolights?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {menuItems.map((item, index) => (
              ...
              >
                ...
                <p className="text-gray-600 mb-4 font-body">{item.description}</p>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button 
                    ...
                    className="bg-red-600 text-white px-4 py-2 rounded-full hover:bg-red-700 transition duration-200 flex items-center gap-2 font-body"
                  >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-xl font-bold font-display">Choolights</h3>
              </div>
              <p className="text-gray-400 font-body">
                Serving authentic Indonesian cuisine with love and tradition.
              </p>
            </div>
            
            <div>
              <h4 className="font-bold mb-4 font-display">Contact</h4>
              <p className="text-gray-400 font-body">hello@choolights.com</p>
              <p className="text-gray-400 font-body">+62 812 3456 7890</p>
            </div>
            ...
            <div>
              <h4 className="font-bold mb-4 font-display">Hours</h4>
              <p className="text-gray-400 font-body">Mon-Sun: 10AM - 10PM</p>
              <p className="text-gray-400 font-body">Open Everyday</p>
            </div>
          </div>
          
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400 font-body">
              &copy; 2024 Choolights. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
